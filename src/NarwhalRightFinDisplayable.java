/**
 * NarwhalRightFinDisplayable.java - a displayable for the narwhals right tail fin
 * 
 * McKenzie Joyce
 * 
 * CS480
...
public class NarwhalRightFinDisplayable implements Displayable {
	...
	public NarwhalRightFinDisplayable(final double radius, final double angle, final GLUT glut) {
		this.radius = radius;
		this.angle = angle;
	}
