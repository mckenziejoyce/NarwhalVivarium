/**
 * PA3.java - main file for Programming Assignment 3
 * 
 * McKenzie Joyce
 * 
 * CS480
...
public class PA3 extends JFrame implements GLEventListener, KeyListener, MouseListener, MouseMotionListener {
	...
	public void keyTyped(KeyEvent key) {
		...
		default:
			break;
		// Put food in the tank 
		case 'F':
		case 'f': 
			vivarium.createFood();
			break;
		//Make the fish school together 
		case 'S':
		case 's':
			vivarium.schoolTogether = !vivarium.schoolTogether;
			vivarium.schoolTogether();
			break;
		}
	}
